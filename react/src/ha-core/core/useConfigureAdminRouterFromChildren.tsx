...
import {type ResourceDefinition, type ResourceProps, type RenderResourcesFunction} from "../types";
import {type CustomRoutesProps} from "./CustomRoutes";
...
export const useConfigureAdminRouterFromChildren = (
    ...
    useRegisterResources(routesAndResources.resources, undefined);
 ...
 */
export const getRoutesAndResourceFromNodes = (
    children: ReactNode
): RoutesAndResources => {
